...
class ToastCatalogAdapterSpy: ToastCatalogServiceable {
    func getItems() async -> Result<[Toast_Catalog.ToastCatalogItem], Toast_Catalog.RequestError> {
        return .success([
            ToastCatalogItem(name: "Avocado Toast", price: "5.99", id: 1, currency: "EUR", lastSold: "2020-11-28T15:14:22Z"),
            ToastCatalogItem(name: "Bacon Toast", price: "1.99", id: 2, currency: "EUR", lastSold: "2021-01-30T02:24:04Z"),
            ToastCatalogItem(name: "Crunchy Toast", price: "0.99", id: 3, currency: "EUR", lastSold: "2021-03-17T03:45:47Z")
                        ])
    }
}
